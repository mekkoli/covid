...
class covidInfections:
  ...
  def __init__( self, covidInit ):
    ...
    self.name = "(x" + str(self.dimX) + " y" + str(self.dimY) + " id" + str(self.infectDuration) + " hd" + str(self.humanDensity) + " ip" + str(self.infectProb) + " ss" + str(self.socialSeparation) + ")"
...
w.cicleWorld()
init = {
  "fileName": "06covInfect",
  "dimX": 1000, 
  "dimY": 1000,
  "infectDuration": 15, 
  "humanDensity": 0.1, 
  "infectProb": 0.5,
  "socialSeparation": 0.6
}  
w=covidInfections(init)
w.cicleWorld()
